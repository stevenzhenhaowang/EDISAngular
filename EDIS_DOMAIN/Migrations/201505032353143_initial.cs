namespace EDIS_DOMAIN.Migrations
{
    using System;
    ...
    public partial class initial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        AdvisorUserId = c.String(nullable: false, maxLength: 128),
                ...
                c => new
                    {
                        ...
                        AssetType = c.String(nullable: false, maxLength: 100, unicode: false),
                    })
                ...
                c => new
                    {
                        ...
                        NoteTypesID = c.Int(nullable: false),
                ...
                c => new
                    {
                        ...
                        AssetType_AssetTypeID = c.Int(nullable: false),
                    })
            ...
            CreateTable(
                "dbo.CommissionsAndFees",
                c => new
                    {
                        CommissionsAndFeesId = c.Int(nullable: false),
                        CommissionsAndFees = c.String(maxLength: 64),
                    })
                .PrimaryKey(t => t.CommissionsAndFeesId);
            ...
            CreateTable(
                "dbo.NewsletterServices",
                c => new
                    {
                        NewsletterServicesId = c.Int(nullable: false),
                        NewsletterServices = c.String(maxLength: 64),
                    })
                .PrimaryKey(t => t.NewsletterServicesId);
        ...
        public override void Down()
        {
            ...
            DropTable("dbo.NewsletterServices");
            ...
            DropTable("dbo.CommissionsAndFees");
