...
{
    public class ManagedInvestmentCompanyProfileModel
    {
        ...
        public List<ManagedInvestmentCompanyProfileItem> data { get; set; }
    }

    public class ManagedInvestmentCompanyProfileItem
    {
