...
(function ($) {
    ...
    $.fn.mapael = function (options) {
        ...
        return this.each(function () {
            ...
            var $container = $('.' + options.map.cssClass, this).empty().append($tooltip);
            var mapConf = $.fn.mapael.maps[options.map.name];
            var cont = $container[0];
            var paper = new Raphael(cont, mapConf.width, mapConf.height);
            var elemOptions = {}
				, resizeTO = 0
				, areas = {}
				, plots = {}
