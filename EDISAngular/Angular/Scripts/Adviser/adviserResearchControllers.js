...
app.controller("adviserResearchAnalysisController", ["$scope", "adviserResearchAnalysisDBService",
    "$modal", function ($scope, service, $modal) {
...
app.controller("adivserResearchCompanyProfileDetailsController", function ($scope) {
...
app.controller("adviserResearchCompareController", ["$scope", "adviserResearchAnalysisDBService", "$timeout", function ($scope, service, $timeout) {
    $scope.userCompanyList = service().getUserCompanyList();
    $scope.details = [];
